class Student:
    ...
    def display_stu_inf(self):
        print(f"ID: {self.__stu_id} | Name: {self.__stu_name} | DoB: {self.__dob}")
    
class Courses:
    def __init__(self,cou_id = "",cou_name = ""):
    ...
    def display_cou_inf(self):
        print(f"Course ID: {self.__cou_id} | Course Name: {self.__cou_name}")
...
class SchoolMa:
    ...
    def input_marks(self):
        ...
        for stu in self.__students:
            ...
            self.__marks[course_id][stu.get_stu_id()] = mark
